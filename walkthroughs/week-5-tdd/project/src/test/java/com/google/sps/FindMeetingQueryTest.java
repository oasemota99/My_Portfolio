...
public final class FindMeetingQueryTest {
  ...
  //Additional Tests for Optional Attendees Functionality
  ...
  public void optionalAttendeeFullDay() {
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 3", TimeRange.WHOLE_DAY, Arrays.asList("Person C"))
    );
  ...
  @Test
  public void optionalAttendeeOneMeeting() {
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TIME_0800AM, DURATION_30_MINUTES), Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES), Arrays.asList(PERSON_B)),
        new Event("Event 3", TimeRange.fromStartDuration(TIME_0830AM, DURATION_30_MINUTES), Arrays.asList("Person C"))
    );
